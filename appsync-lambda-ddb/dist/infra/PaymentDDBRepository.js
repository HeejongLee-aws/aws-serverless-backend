 ...
 *
 */
var PaymentDDBRepository = /** @class */ (function () {
    function PaymentDDBRepository() {
        this.mapper = new dynamodb_data_mapper_1.DataMapper({
            client: new AWS.DynamoDB({ region: 'ap-northeast-2' })
        });
    }
    PaymentDDBRepository.prototype.save = function (payment) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mapper.put(payment)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    PaymentDDBRepository.prototype.get = function (partitionkey, sortkey) {
        return __awaiter(this, void 0, void 0, function () {
            var toGet;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        toGet = Object.assign(new Payment_1.default, {
                            partitionkey: partitionkey,
                            sortkey: sortkey
                        });
                        return [4 /*yield*/, this.mapper.get(toGet)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @param sortkey
     */
    PaymentDDBRepository.prototype.query = function (partitionkey, sortkey) {
        var e_1, _a;
        return __awaiter(this, void 0, void 0, function () {
            var iterator, iterator_1, iterator_1_1, record, e_1_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        iterator = this.mapper.query(Payment_1.default, {
                            partitionkey: partitionkey,
                            sortkey: dynamodb_expressions_1.beginsWith(sortkey)
                        });
                        _b.label = 1;
                    case 1:
    ...
    return PaymentDDBRepository;
}());
exports.default = PaymentDDBRepository;
